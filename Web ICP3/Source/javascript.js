...
function win(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " Your option: " + convertToWord(userOption) + ". Computer's option: " + convertToWord(computerOption) + ". YOU WIN! ";

}

function lose(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " Your option: " + convertToWord(userOption) + ". Computer's option: " + convertToWord(computerOption) + ". YOU LOST! .";
}

function draw(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " Your option: " + convertToWord(userOption) + ". Computer's option: " + convertToWord(computerOption) + ". IT'S A DRAW! .";
}
